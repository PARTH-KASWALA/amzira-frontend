...
| Razorpay test account | Local test-mode INR 100 order create and fetch succeeded; no live charge | Pass |
...
| Shiprocket test account | Login HTTP 200 and serviceability HTTP 200 with 2 available couriers | Pass |
